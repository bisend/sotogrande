...
<td valign = "top">                             <table width = "150" border = "0" cellspacing = "0" cellpadding = "0" align = "right" class = "em_wrapper">                               <TR>                                 <td align = "right" class = "em_align_cent1" style = "font-family:" Open Sans ", Arial, sans-serif; font-size: 12px; line-height: 16px; color: # 848789; text-decoration : подчеркнуть; ">                                   <a href="#" target="_blank" style="text-decoration:underline; color:#848789;"> Просмотр в Интернете </a>
